#ifndef CFMAPMARKER_DEFAULT_P_H
#define CFMAPMARKER_DEFAULT_P_H
...
class CFMapMarkerDefaultPrivate : public CFMapMarkerPrivate
{
    Q_OBJECT
public:
    CFMapMarkerDefaultPrivate(CFMapMarkerLayer *q);
    ~CFMapMarkerDefaultPrivate();
